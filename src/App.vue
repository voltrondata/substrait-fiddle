...
<template>
  <header>
    <nav class="navbar navbar-dark navbar-expand-md py-4 shadow-lg p-3 mb-5" style="background-color: #e92063;">
      <img class="inverted" src="../public/logo.svg" alt="Substrait Fiddle" style="width:4%; margin:0%; padding: 0%; border: 0ch;"/>
      <span class="nav-header" style="color: #fff; margin-left: 1vh; font-size-adjust:0.5;">Substrait Fiddle</span>
    </nav>
  </header>
  <div class="col-5" style="margin-left: 2vh;">
    ...
    <li class="nav-item" role="presentation">
      <router-link to="/"  style="text-decoration: none; color: inherit;">
        <button class="nav-link active" id="code-tab" data-bs-toggle="tab" data-bs-target="#code" type="button" role="tab" aria-controls="code" aria-selected="true">
          Code
        </button>
      </router-link>  
      </li>
